                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              CommonText(text: "Don't have an Account?",color: Colors.black,),
                              TextButton(onPressed: () {
                                  Navigation.pushNamed(Routes.signUpScreen);
                              }, child: CommonText(text: "SignUp Here",color: Colors.black,fontWeight: FontWeight.w500,))
                            ],
                          ),
                          CommonText(text: "Or",color: Colors.grey,),

                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              CommonText(text: "Are you an Admin?",color: Colors.black,),
                              TextButton(onPressed: () {

                              }, child: CommonText(text: "Click Here",color: Colors.black,fontWeight: FontWeight.w500,))
                            ],
                          )
                        ],
                      ),
