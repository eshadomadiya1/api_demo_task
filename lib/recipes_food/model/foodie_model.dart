...
class FoodieDataModel {
  List<Recipes>? recipes;
  int? total;
  int? skip;
  int? limit;

  FoodieDataModel({this.recipes, this.total, this.skip, this.limit});

  FoodieDataModel.fromJson(Map<String, dynamic> json) {
